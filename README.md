...
- **Расчет Traffic = rps * avg_request_size**
  ...
  >   - Traffic = 926 * 73,7КБ = 68 279 КБ/с
  > - Просмотр ленты постов (1 пост = 1МБ) 
  >   - RPS = 347    
  >   - Traffic = 347 * 100 = 34 700 кб/с (получение постов и ссылок на фото)
  >   - Traffic = 347 * 900 = 312 300 кб/с (получение фото)
  ...
  > - Отправка сообщений    
  >   - RPS = 69,4   
  >   - Traffic = 69,4 * 5 = 347 кб/с 
  > - Отправка комментария  
  >   - RPS= 34,7    
  >   - Traffic = 34,7 * 5 = 173,5 кб/с 
  > - Отправка поста        
  >   -   RPS = 11,5   
  >   - Traffic = 11,5 * 1000 = 11500 кб/с
...
- **Оценка дисков для хранения и обработки данных**
  ...
  > - Расчет объема данных для постов:
  > - Сapacity = 11,5 МБ/с * 86 400 * 365 = 350 ТБ
  > - Disks_for_capacity = 350 ТБ / 15 ТБ = 23,3 (Samsung PM9A3)
  > - Disks_for_throughput = (11,5 МБ/с + 312,3  МБ/с)/ 500 МБ/с = 0,65 
  > - Disks_for_iops = 926 / 1000 = 0.93
  > - Disks = max(ceil(23,3), ceil(0,023), ceil(0,023), ceil(0,93)) = 24

  > - Расчет объема данных для сообщений:
  > - Сapacity = 0,347 МБ/с * 86 400 * 365 = 10,4 ТБ
  > - Disks_for_capacity = 10,4 ТБ / 15 ТБ = 0,7 (Samsung PM9A3)
  > - Disks_for_throughput = (17,35 + 0,347) МБ/с / 500 МБ/с = 0,035
  > - Disks_for_iops = 926 / 1000 = 0,93
  > - Disks = max(ceil(0,7), ceil(0,035), ceil(0,93)) = 1

  > - Расчет объема данных для комментариев:
  > - Сapacity = 0,174 МБ/с * 86 400 * 365 = 5,23 ТБ
  > - Disks_for_capacity = 5,23 ТБ / 15 ТБ = 0,35 (Samsung PM9A3)
  > - Disks_for_throughput = (2,3 + 0,174) МБ/с / 500 МБ/с = 0,005
  > - Disks_for_iops = 926 / 1000 = 0.93
  > - Disks = max(ceil(0,35), ceil(0,005), ceil(0,93)) = 1
...
- **Расчет приблизительного количества хостов для хранения и обработки данных**
  ...
  > - для хранения постов:
  >   - Hosts = 25 / 4 = 6.25 (округляем до 7)  
  >   - Hosts_with_replication = 7 * 2 = 14  
  > - для обработки запросов постов (с шардированием):
  >   - Hosts = 4 (по 1 на каждый шард)  

  > - для хранения сообщений:
  >   - Hosts = 1 / 4 = 0,25 (округляем до 1)   
  >   - Hosts_with_replication = 1 * 2 = 2
  > - для обработки запросов сообщений (с шардированием):
  >   - Hosts = 4 (по 1 на каждый шард)

  >  -  для хранения комментариев:
  >    - Hosts = 1 / 4 = 0,25 (округляем до 1)   
  >    - Hosts_with_replication = 1 * 2 = 2
  > - для обработки запросов комментариев (с шардированием):
  >   - Hosts = 4 (по 1 на каждый шард)
